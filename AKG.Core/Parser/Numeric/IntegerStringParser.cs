...
public static class IntegerStringParser
{
    public static void ParseAndAdjustIndexFromString(string indexString, out int parsedIndex)
    {
    ...
    private static int AdjustParsedIndex(int parsedIndex)
    {
        if (parsedIndex > 0)
        {
